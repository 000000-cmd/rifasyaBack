...
@Entity
@Table(name = "listdrawmethods")
public class ListDrawMethod {
    @Id
    @Column(name = "IdList")
    private UUID id;
    ...
    public ListDrawMethod() {}

    public ListDrawMethod(UUID id, String code, String name, Integer order, Boolean indicatorEnabled, User userAudit, LocalDateTime auditDate) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.order = order;
    ...
    public boolean equals(Object o) {
        ...
        ListDrawMethod that = (ListDrawMethod) o;
