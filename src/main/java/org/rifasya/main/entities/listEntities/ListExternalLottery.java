...
@Entity
@Table(name = "listexternallotteries")
public class ListExternalLottery {
    @Id
    @Column(name = "IdList")
    private UUID id;
    ...
    public ListExternalLottery() {}

    public ListExternalLottery(UUID id, String code, String name, Integer order, Boolean indicatorEnabled, User userAudit, LocalDateTime auditDate) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.order = order;
    ...
    public boolean equals(Object o) {
        ...
        ListExternalLottery that = (ListExternalLottery) o;
