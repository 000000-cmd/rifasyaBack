...
@Entity
@Table(name = "listprizetypes")
public class ListPrizeType {
    @Id
    @Column(name = "IdList")
    private UUID id;
    ...
    public ListPrizeType() {}

    public ListPrizeType(UUID id, String code, String name, Integer order, Boolean indicatorEnabled, User userAudit, LocalDateTime auditDate) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.order = order;
    ...
    public boolean equals(Object o) {
        ...
        ListPrizeType that = (ListPrizeType) o;
