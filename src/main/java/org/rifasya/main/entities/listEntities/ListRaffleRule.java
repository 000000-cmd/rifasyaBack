...
@Entity
@Table(name = "listrafflerules")
public class ListRaffleRule {
    @Id
    @Column(name = "IdList")
    private UUID id;
    ...
    public ListRaffleRule() {}

    public ListRaffleRule(UUID id, String code, String name, Integer order, Boolean indicatorEnabled, User userAudit, LocalDateTime auditDate) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.order = order;
    ...
    public boolean equals(Object o) {
        ...
        ListRaffleRule that = (ListRaffleRule) o;
